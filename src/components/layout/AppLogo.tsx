...
export function AppLogo({ className }: AppLogoProps) {
  ...
  if (!currentLogo) {
    // Fallback or initial render before theme is resolved, render a simple placeholder or light mode by default
    // To avoid layout shift, you might render a placeholder of the same size
    return <div className={className || 'h-6 w-6'} aria-label="Loading logo..." />;
  }
