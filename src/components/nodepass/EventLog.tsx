...
//       }
//     }, RECONNECT_DELAY_MS);
//   }, [apiId, apiRoot, addEventToLog, connectWithFetch]);
...
//       }
//     };
//   }, [apiId, apiRoot, apiToken, apiName, connectWithFetch, uiConnectionStatus]);
...
//                              onClick={(e) => {
//                                e.stopPropagation();
//                                handleCopyToClipboard(instance.url, isApiKeyInstance ? 'API 密钥' : 'URL');
//                              }}
//                            >
...
// // This file is no longer needed and can be removed as the EventLog component has been removed.
// // The functionality for real-time event logging has been deprecated.
// // If you wish to re-enable it, you would need to restore this component and 
// // integrate it back into the application, likely on the main page (src/app/page.tsx).
// // Please ensure that if your SSE endpoint requires custom headers like X-API-Key,
// // you use a fetch-based implementation or a server-side proxy, as EventSource
// // alone cannot send custom headers.
// // The content has been commented out to preserve the logic if you decide to
// // re-implement this feature in the future.
